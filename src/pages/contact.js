            ...
            <section class="text-gray-700 body-font relative">
                <div class="container px-5 py-10 mx-auto">
                    <div class="flex flex-col text-center w-full mb-12">
                        ...
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Let’s talk 👋 Don’t hesitate to reach out with the contact information below, or send a message using the form. </p>
                    </div>
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                ...
                                <a class="text-indigo-500">jamalniyaz@live.com</a>
                                <p class="leading-normal my-5">Lengkok Tun Sambanthan, Brickfields, Kuala Lumpur, 50470</p>
